...
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(1, 1, 1, 1, 999.99, 'completada'), -- Juan Perez compra Smartphone Ultra X a Vendedor 1 (Luis Torres)
(4, 2, 2, 1, 1899.00, 'pendiente'), -- Pedro Castro compra Laptop Gaming Pro a Vendedor 2 (Marta Soto)
(9, 3, 3, 2, 299.00, 'completada'), -- Elena Jiménez compra 2 Auriculares Inalámbricos HD a Vendedor 3 (Sofía Vargas)
(1, 1, 4, 1, 219.99, 'completada'), -- Juan Perez compra Smartwatch Deportivo a Vendedor 1 (Luis Torres)
(6, 2, 5, 1, 789.00, 'pendiente');  -- Diego Morales compra Tablet Pro M1 a Vendedor 2 (Marta Soto)

-- Ventas para 'Electrodomésticos' (Productos 6-10, Vendedores 4,5,6)
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(11, 4, 6, 1, 1200.00, 'completada'), -- Gabriela Díaz compra Refrigerador Inverter Smart a Vendedor 4
(14, 5, 7, 1, 650.00, 'pendiente'),  -- Daniel Salazar compra Lavadora a Vendedor 5
(19, 6, 8, 1, 120.00, 'completada'), -- Natalia Castillo compra Horno Microondas a Vendedor 6
(1, 4, 9, 1, 350.00, 'completada'),  -- Juan Perez compra Aspiradora Robot a Vendedor 4
(4, 5, 10, 1, 280.00, 'pendiente');  -- Pedro Castro compra Cafetera Expreso a Vendedor 5

-- Ventas para 'Hogar y Muebles' (Productos 11-15, Vendedores 7,8,9)
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(9, 7, 11, 1, 850.00, 'completada'), -- Elena Jiménez compra Sofá Seccional a Vendedor 7
(11, 8, 12, 1, 520.00, 'pendiente'), -- Gabriela Díaz compra Mesa de Comedor a Vendedor 8
(14, 7, 13, 1, 75.00, 'completada'), -- Daniel Salazar compra Sábanas de Algodón a Vendedor 7
(19, 8, 14, 1, 95.00, 'completada'), -- Natalia Castillo compra Lámpara de Pie a Vendedor 8
(21, 9, 15, 1, 60.00, 'pendiente');  -- Carolina Cárdenas compra Set de Utensilios a Vendedor 9

-- Ventas para 'Deportes y Fitness' (Productos 16-20, Vendedores 10,11,12)
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(24, 10, 16, 1, 450.00, 'completada'), -- Gustavo Reyes compra Bicicleta de Montaña a Vendedor 10
(26, 11, 17, 1, 200.00, 'pendiente'), -- Martín Quispe compra Mancuernas Ajustables a Vendedor 11
(29, 10, 18, 1, 580.00, 'completada'), -- Andrea Torres compra Cinta de Correr a Vendedor 10
(1, 11, 19, 2, 50.00, 'completada'),  -- Juan Perez compra 2 Esterillas de Yoga a Vendedor 11
(4, 12, 20, 1, 110.00, 'pendiente');  -- Pedro Castro compra Monitor de Ritmo Cardíaco a Vendedor 12

-- Ventas para 'Mascotas' (Productos 21-25, Vendedores 13,14,15)
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(6, 13, 21, 1, 60.00, 'completada'),  -- Diego Morales compra Alimento para Perro a Vendedor 13
(9, 14, 22, 1, 85.00, 'pendiente'),   -- Elena Jiménez compra Rascador para Gatos a Vendedor 14
(11, 13, 23, 1, 70.00, 'completada'), -- Gabriela Díaz compra Cama Ortopédica a Vendedor 13
(14, 14, 24, 1, 15.00, 'completada'), -- Daniel Salazar compra Juguetes Interactivos a Vendedor 14
(19, 15, 25, 1, 30.00, 'pendiente');  -- Natalia Castillo compra Correa Retráctil a Vendedor 15

-- Ventas para 'Belleza y Cuidado personal' (Productos 26-30, Vendedores 16,17,18)
INSERT INTO ventas (id_usuario, id_vendedor, id_producto, cantidad, total, estado)
VALUES
(21, 16, 26, 1, 90.00, 'completada'), -- Carolina Cárdenas compra Set de Maquillaje a Vendedor 16
(24, 17, 27, 1, 45.00, 'pendiente'),  -- Gustavo Reyes compra Crema Hidratante a Vendedor 17
(26, 16, 28, 1, 70.00, 'completada'), -- Martín Quispe compra Secador de Pelo a Vendedor 16
(29, 17, 29, 1, 120.00, 'completada'), -- Andrea Torres compra Perfume a Vendedor 17
(1, 18, 30, 1, 55.00, 'pendiente');   -- Juan Perez compra Kit de Afeitado a Vendedor 18
...
VALUES
(1, 1, 5, 'Excelente smartphone, muy rápido y con una cámara impresionante.'),
(2, 4, 4, 'La laptop es potente, pero el teclado se calienta un poco con uso intenso.'),
(3, 9, 5, 'Auriculares de gran calidad de sonido, cómodos y la cancelación de ruido es efectiva.'),
(4, 1, 4, 'El smartwatch funciona bien, pero la batería podría durar un poco más.'),
(5, 6, 5, 'Tablet muy fluida y con una pantalla vibrante, ideal para trabajar y ver contenido.'),

(6, 11, 5, 'El refrigerador es espacioso y muy eficiente energéticamente. Me encanta el control inteligente.'),
(7, 14, 3, 'La lavadora es buena, pero hace un poco de ruido durante el centrifugado.'),
(8, 19, 4, 'Horno microondas práctico y fácil de usar, calienta muy rápido.'),
(9, 1, 5, 'Esta aspiradora robot me ha cambiado la vida, limpia muy bien y es silenciosa.'),
(10, 4, 4, 'Cafetera rápida y con un buen diseño. El café sale delicioso.'),

(11, 9, 5, 'Sofá muy cómodo y con un diseño moderno, se ve genial en mi sala.'),
(12, 11, 4, 'Mesa de comedor sólida y elegante, fácil de armar.'),
(13, 14, 5, 'Las sábanas son súper suaves y frescas, duermo como un bebé.'),
(14, 19, 4, 'Lámpara de pie con buena iluminación y las opciones de regulación son útiles.'),
(15, 21, 5, 'Set de utensilios de cocina de excelente calidad, no se pegan y son fáciles de limpiar.'),

(16, 24, 5, 'La bicicleta es robusta y muy divertida para paseos por la montaña.'),
(17, 26, 4, 'Las mancuernas son muy versátiles, aunque un poco grandes para guardar.'),
(18, 29, 5, 'Cinta de correr muy completa y plegable, perfecta para espacios pequeños.'),
(19, 1, 5, 'Esterilla de yoga con buen agarre, no se resbala y es muy cómoda.'),
(20, 4, 3, 'El monitor de ritmo cardíaco es preciso, pero la app a veces falla la sincronización.'),

(21, 6, 5, 'A mi perro le encanta este alimento, se ve más activo y con el pelo brillante.'),
(22, 9, 4, 'Rascador para gatos resistente, mis gatos lo usan todo el tiempo.'),
(23, 11, 5, 'Cama ortopédica para mascotas, mi perro ya no se queja de sus articulaciones.'),
(24, 14, 5, 'Los juguetes interactivos mantienen a mis gatos entretenidos por horas.'),
(25, 19, 4, 'Correa retráctil resistente y segura, buen control para perros grandes.'),

(26, 21, 5, 'El set de maquillaje tiene colores vibrantes y de larga duración.'),
(27, 24, 4, 'La crema hidratante es ligera y deja la piel muy suave. Me gusta.'),
(28, 26, 5, 'Secador de pelo potente y rápido, el cabello queda suave y sin frizz.'),
(29, 29, 5, 'Este perfume tiene una fragancia exquisita y duradera, muy recomendable.'),
(30, 1, 4, 'El kit de afeitado clásico es muy completo, aunque requiere práctica para usar la navaja.');
...
VALUES
-- Ofertas activas para junio 2025
(1, 1, 'porcentaje', 10.00, '2025-06-01 00:00:00', '2025-06-15 23:59:59', 'activa'),    -- Smartphone Ultra X (10% Dcto)
(2, 2, 'monto_fijo', 150.00, '2025-06-05 09:00:00', '2025-06-30 23:59:59', 'activa'),   -- Laptop Gaming Pro (150.00 Dcto)
(6, 4, 'porcentaje', 5.00, '2025-05-28 00:00:00', '2025-06-10 23:59:59', 'activa'),    -- Refrigerador Inverter Smart (5% Dcto)
(11, 7, 'monto_fijo', 50.00, '2025-06-01 00:00:00', '2025-06-07 23:59:59', 'activa'),   -- Sofá Seccional Moderno (50.00 Dcto)
(16, 10, 'porcentaje', 12.00, '2025-06-03 12:00:00', '2025-06-20 23:59:59', 'activa'),  -- Bicicleta de Montaña Aro 29 (12% Dcto)
(21, 13, 'porcentaje', 8.00, '2025-06-01 00:00:00', '2025-06-30 23:59:59', 'activa'),   -- Alimento Premium para Perro Adulto (8% Dcto)
(26, 16, 'monto_fijo', 10.00, '2025-06-02 00:00:00', '2025-06-09 23:59:59', 'activa'),   -- Set de Maquillaje Profesional (10.00 Dcto)
(31, 1, 'porcentaje', 7.50, '2025-06-01 00:00:00', '2025-06-14 23:59:59', 'activa'),   -- Taladro Percutor Inalámbrico (7.5% Dcto)
(36, 4, 'monto_fijo', 5.00, '2025-06-01 00:00:00', '2025-06-10 23:59:59', 'activa'),    -- Martillo de Uña Forjado (5.00 Dcto)
(41, 11, 'porcentaje', 15.00, '2025-06-01 00:00:00', '2025-06-25 23:59:59', 'activa');  -- Cochecito de Bebé Convertible 3 en 1 (15% Dcto)

-- Ofertas futuras (aún no activas)
INSERT INTO ofertas_promociones (id_producto, id_vendedor, tipo_oferta, valor, fecha_inicio, fecha_fin, estado)
VALUES
(7, 5, 'porcentaje', 10.00, '2025-07-01 00:00:00', '2025-07-15 23:59:59', 'inactiva'),   -- Lavadora Carga Frontal 12kg
(12, 8, 'monto_fijo', 20.00, '2025-07-10 00:00:00', '2025-07-31 23:59:59', 'inactiva');   -- Mesa de Comedor de Madera Maciza

-- Ofertas pasadas (ya no activas)
INSERT INTO ofertas_promociones (id_producto, id_vendedor, tipo_oferta, valor, fecha_inicio, fecha_fin, estado)
VALUES
(3, 3, 'porcentaje', 10.00, '2025-05-01 00:00:00', '2025-05-31 23:59:59', 'inactiva'),    -- Auriculares Inalámbricos HD
(8, 6, 'monto_fijo', 15.00, '2025-04-15 00:00:00', '2025-05-15 23:59:59', 'inactiva'),    -- Horno Microondas Digital 30L
(18, 10, 'porcentaje', 5.00, '2025-05-10 00:00:00', '2025-05-20 23:59:59', 'inactiva');   -- Cinta de Correr Plegable

-- Paso 11:
-- Inserción de 20 datos de ejemplo en la tabla mensajes

INSERT INTO mensajes (id_remitente, id_receptor, id_venta, asunto, contenido, estado)
VALUES
-- Mensajes relacionados con ventas
(1, 2, 1, 'Consulta sobre Smartphone Ultra X', 'Hola, ¿el Smartphone Ultra X tiene garantía?', 'no_leido'),       -- Comprador 1 a Vendedor 1 (sobre Venta 1)
(2, 1, 1, 'Re: Consulta sobre Smartphone Ultra X', 'Sí, tiene 1 año de garantía directamente con el fabricante.', 'leido'),
(4, 5, 2, 'Estado del envío de Laptop', 'Quisiera saber el estado de mi envío de la Laptop Gaming Pro.', 'no_leido'), -- Comprador 4 a Vendedor 2 (sobre Venta 2)
(5, 4, 2, 'Re: Estado del envío de Laptop', 'Su envío está en camino, se espera para el 05/06/2025.', 'leido'),
(9, 3, 3, 'Agradecimiento por auriculares', 'Los auriculares son fantásticos, ¡muchas gracias!', 'leido'),       -- Comprador 9 a Vendedor 3 (sobre Venta 3)
(3, 9, 3, 'Re: Agradecimiento por auriculares', '¡De nada! Me alegra que le gusten.', 'leido'),
(6, 2, 5, 'Duda sobre la Tablet Pro M1', '¿La Tablet Pro M1 incluye lápiz digital?', 'no_leido'),            -- Comprador 6 a Vendedor 2 (sobre Venta 5)
(2, 6, 5, 'Re: Duda sobre la Tablet Pro M1', 'No, el lápiz se vende por separado.', 'leido'),
(11, 4, 6, 'Problema con el refrigerador', 'El refrigerador llegó con un pequeño golpe en la puerta.', 'no_leido'), -- Comprador 11 a Vendedor 4 (sobre Venta 6)
(4, 11, 6, 'Re: Problema con el refrigerador', 'Lamentamos el inconveniente, nos pondremos en contacto para gestionar la devolución.', 'no_leido'),

-- Mensajes generales (no necesariamente ligados a una venta específica aún)
(1, 7, NULL, 'Pregunta sobre Sofá Seccional', '¿Tienen este sofá en otros colores disponibles?', 'leido'),
(7, 1, NULL, 'Re: Pregunta sobre Sofá Seccional', 'Sí, tenemos en gris oscuro y beige. ¿Le gustaría ver fotos?', 'no_leido'),
(14, 10, NULL, 'Consulta de stock - Bicicleta', '¿Tienen más unidades de la Bicicleta de Montaña Aro 29?', 'leido'),
(10, 14, NULL, 'Re: Consulta de stock - Bicicleta', 'Sí, tenemos 30 unidades en stock.', 'no_leido'),
(19, 13, NULL, 'Duda sobre Alimento Perro', '¿El alimento premium para perros es apto para cachorros?', 'leido'),
(13, 19, NULL, 'Re: Duda sobre Alimento Perro', 'No, este alimento es solo para perros adultos.', 'no_leido'),
(21, 16, NULL, 'Consulta de oferta - Maquillaje', '¿La oferta del set de maquillaje dura hasta fin de mes?', 'leido'),
(16, 21, NULL, 'Re: Consulta de oferta - Maquillaje', 'Sí, la oferta es válida hasta el 30 de junio.', 'no_leido'),
(24, 17, NULL, 'Disponibilidad de Crema Hidratante', '¿Tienen este producto en presentación más grande?', 'leido'),
(17, 24, NULL, 'Re: Disponibilidad de Crema Hidratante', 'Por el momento solo esta presentación. Próximamente.', 'no_leido');
